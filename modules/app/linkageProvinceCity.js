...
$(function () {
    ...
    var city = new Array();
    city[1] = new Array("东城区","西城区","朝阳区","海淀区","丰台区","石景山区","房山区","通州区","顺义区","大兴区","昌平区","平谷区","怀柔区","门头沟区","密云县","延庆县");
    city[2] = new Array("和平","河西","河东","南开","红桥","河北","东丽","西青","津南","北辰","滨海新区");
    city[3] = new Array("浦东新区", "长宁区", "宝山区", "青浦区", "黄浦区", "普陀区", "闵行区", "奉贤区", "卢湾区", "闸北区", "嘉定区", "静安区", "虹口区", "金山区", "徐汇区", "杨浦区", "松江区", "崇明县");
    city[4] = new Array("渝中区","沙坪坝区","江北区","南岸区","大渡口区","九龙坡区","渝北区","巴南区","北碚区");
